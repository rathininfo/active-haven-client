...
const FeaturedClasses = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-gray-100 via-gray-100 to-gray-100 py-20">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {classes.map((classItem, index) => (
            <div
              key={index}
              className="bg-gray-800 p-6 rounded-3xl shadow-2xl transition-all hover:scale-105 hover:shadow-xl duration-300 ease-in-out"
            >
